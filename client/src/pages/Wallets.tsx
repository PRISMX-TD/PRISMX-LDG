...
import { walletTypeLabels } from "@shared/schema";
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {groupedWallets.map(({ type, wallets: typeWallets }) => {
            ...
            const totalBalance = typeWallets.reduce((sum, w) => sum + parseFloat(w.balance || "0"), 0);
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-mono text-muted-foreground">
                          {totalBalance >= 0 ? '+' : ''}{totalBalance.toLocaleString("zh-CN", { minimumFractionDigits: 2 })}
                        </span>
                        {isCollapsed ? (
